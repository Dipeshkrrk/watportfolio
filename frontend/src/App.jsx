...
export default function App() {
    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-70 z-0"/> {/* Content Wrapper */}
            <div className="relative z-10 text-white font-sans min-h-screen">
                <nav
                    className="backdrop-blur-lg bg-zinc-950/80 border-b border-zinc-800 sticky top-0 z-50 shadow-md">
                    <div className="flex justify-between items-center px-6 md:px-16 py-4">
                        ...
                        <ul className="hidden md:flex gap-8 text-gray-300 font-medium">
                            {
                                ["about", "services", "portfolio", "how-it-works", "contact"].map(
                                    (section) => (
                                        <li
                                            key={section}
                                            ...
                                            <span
                                                className="absolute left-0 -bottom-1 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-300 group-hover:w-full"></span>
                                        </li>
                                    )
                                )
                            }
